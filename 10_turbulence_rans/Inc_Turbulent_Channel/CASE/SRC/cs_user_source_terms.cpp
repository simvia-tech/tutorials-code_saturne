/*============================================================================
 * Inc_Turbulent_Channel - constant streamwise momentum source term.
 *
 ...
 * friction on the two walls, so it fixes the friction velocity (and hence the
 * friction Reynolds number Re_tau = u_tau * h / nu) by construction, while the
 * bulk velocity is an output of the run.
 *
